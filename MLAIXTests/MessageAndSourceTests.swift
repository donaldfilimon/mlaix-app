...
struct SourceTests {
    ...
    @Test func testSourceAcceptsUnknownFallback() {
        let source = Source(text: "Retrieved text", source: "Unknown")
        #expect(source.text == "Retrieved text")
        #expect(source.source == "Unknown")
        #expect(source.info.url == "Unknown")
    }
