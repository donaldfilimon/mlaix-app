...
struct RetrievalSettingsView: View {
    ...
    var useMemoryToggle: some View {
        HStack(
            ...
            VStack(
                ...
                Text("Controls whether MLAIX remembers information about you to provide more customized, personal responses in the future.")
                    .font(.caption)
            }
            Spacer()
    ...
    var tavilyApiKeyEditor: some View {
        HStack(alignment: .center) {
            ...
            SecureField("", text: $tavilyApiKey)
                ...
                .frame(width: 300)
                .onChange(of: tavilyApiKey, initial: false) { oldValue, newValue in
    ...
    var searchResultContext: some View {
        ...
        .onChange(of: useWebSearchResultContext, initial: false) { _, _ in
