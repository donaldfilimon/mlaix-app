...
struct ExportButton: View {
    ...
    private let iconName: String = "document.badge.plus"
    ...
    struct ConfirmationSheet: View {
        ...
        private func saveCode() {
            ...
            do {
                ...
                Logger(subsystem: Bundle.main.logSubsystem, category: "ExportButton").error("Export failed: \(error.localizedDescription, privacy: .public)")
            }
        }
