...
public class ConversationManager {
    ...
    public func load(
        ...
        do {
            ...
            Self.logger.error("Failed to load conversations: \(error.localizedDescription, privacy: .public)")
            self.newDatastore()
        }
    }
    ...
    public func patchFileIntegrity() {
        ...
        if !self.datastoreDirExists {
            do {
                ...
                Self.logger.error("Failed to create datastore directory: \(error.localizedDescription, privacy: .public)")
            }
        }
    }
