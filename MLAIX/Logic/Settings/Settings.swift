...
public class Settings {
	...
	public static var username: String {
		get {
			guard let username = UserDefaults.standard.string(
				...
				Logger(subsystem: Bundle.main.logSubsystem, category: "Settings").debug("Failed to get username, using default")
	...
	static let containerUrl: URL = URL
		...
		.appendingPathComponent("com.donaldfilimon.mlai")
