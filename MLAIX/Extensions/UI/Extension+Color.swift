...
extension Color {
	...
	// Asset catalog colors (manual declarations since ASSETCATALOG_COMPILER_GENERATE_SWIFT_ASSET_SYMBOL_EXTENSIONS = NO)
	static let brightGreen = Color("brightGreen")
	static let groupBoxBackground = Color("groupBoxBackground")
	static let textBackground = Color("TextBackground")
	static let buttonBackground = Color("buttonBackground")
	static let orbBg = Color("orbBg")
	static let toolbarText = Color("toolbarText")
	static let tutorialExpert = Color("tutorialExpert")
